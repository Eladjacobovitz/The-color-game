    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-nav-demo">
            <ul class="nav navbar-nav">
                ...
                <li><a href="#" onclick="onNavigate('/pregame'); return false;"><span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span> Game menu</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container">
        <img id="rgbmap" src="https://excelatfinance.com/xlf/media/xlf-colindx2ws.png">
        ...
        <h3 id="explanation">
            ...
            <br>The name of the model comes from the initials of the three additive primary colors, red, green, and blue.
        </h3>
</div>
