...
<div id="logform" class="login">
      ...
      <h3>Login</h3>
      <form id="form" onsubmit="event.preventDefault(); send_login_details();">
        ...
        <button id="let_me_in" type="submit" class="btn btn-primary btn-block btn-large" value="Submit form">Let me in</button>
        <button id="forget" class="btn btn-block" onclick="send_forgetPassword_request()">Forget your password?</button>
      </form>
</div>
