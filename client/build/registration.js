...
<div class="login">
   <div id="logform" class="login">
    ...
    <h3>Registration</h3>
    <form id="regform">
        <input id="reg_email" type="text" name="e" placeholder="Email address" required="required" />
        <input id="reg_name" type="text" name="u" placeholder="Username" required="required" />
        <input id="reg_pass" type="password" name="p" placeholder="Password" required="required" />
        <button id="registration" class="btn btn-primary btn-block btn-large" onclick="send_registration_details('/reg');" value="Submit form">Register</button>
    </form>
    </div>
</div>
